...
public class FadeInTransiction extends Transiction {
	...
	public FadeInTransiction(Renderer renderer, Color fadeFrom) {
		super(renderer);
	...
	public void render(float delta) {
		...
		gl.glColor4f(fadeFrom.r, fadeFrom.g, fadeFrom.b, alpha);
